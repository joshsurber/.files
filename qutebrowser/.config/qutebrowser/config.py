...
# Type: ShellCommand
c.fileselect.single_file.command = ['kitty', '-e', 'vifm', '--choosefile={}']
...
# read instead.
# Type: ShellCommand
c.fileselect.multiple_files.command = ['kitty', '-e', 'vifm', '--choosefiles={}']
...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://google.com/search?q={}', 'am': 'https://www.amazon.com/s?k={}', 'arch': 'https://wiki.archlinux.org/?search={}', 're': 'https://www.reddit.com/r/{}', 'wiki': 'https://en.wikipedia.org/wiki/{}', 'yt': 'https://www.youtube.com/results?search_query={}', 'man': 'https://man.archlinux.org/man/{}'}
