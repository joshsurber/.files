...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, ";", function() awful.spawn('qutebrowser') end, { description = "launch qutebrowser", group = "launcher" }),
    ...
    awful.key({ modkey }, "r", function() awful.util.spawn('dmenu_run') end, { description = "run dmenu", group = "launcher" }),
